defmodule Stash.Commands.UpdateUser do
  defstruct [:user_id, :email, :password]
...
defimpl Stash.Protocol.UniqueFields, for: Stash.Commands.UpdateUser do
...
defimpl Stash.Protocol.ValidCommand, for: Stash.Commands.UpdateUser do
